...
$monName = ''
try {
  $wmiMon = @(Get-CimInstance -Namespace rootwmi -ClassName WmiMonitorID -ErrorAction SilentlyContinue) | Select-Object -First 1
...
$sizeInch = ''
try {
  $bmp = Get-CimInstance -Namespace rootwmi -ClassName WmiMonitorBasicDisplayParams -ErrorAction SilentlyContinue | Select-Object -First 1
