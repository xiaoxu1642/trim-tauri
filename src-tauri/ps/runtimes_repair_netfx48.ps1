# <<<PROVENANCE
# 来源：vendor/upstream-js/src/scripts-powershell/runtimes-scripts.js → repair("netfx48", "@@TRIM_INSTALLER_PATH@@")
...
$result = Start-Process -FilePath '@@TRIM_INSTALLER_PATH@@' -ArgumentList '/q /norestart' -Wait -PassThru
